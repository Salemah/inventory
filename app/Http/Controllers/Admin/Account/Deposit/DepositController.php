...
class DepositController extends Controller
{
    ...
    public function create()
    {
        try {
            ...
            return view('admin.account.deposit.create',compact('bank_accounts','cash_account'));
        } catch (\Exception $exception) {
            return redirect()->back()->with('error', $exception->getMessage());
        }
    }
    ...
    public function edit($id)
    {
        try {
           ...
           return view('admin.account.deposit.edit',compact('transaction','bank_accounts','accountBalance','cash_account'));
        } catch (\Exception $exception) {
