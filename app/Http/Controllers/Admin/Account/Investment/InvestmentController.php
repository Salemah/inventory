...
class InvestmentController extends Controller
{
        ...
        try {
            if ($request->ajax()) {
                ...
                return DataTables::of($investment)
                    ...
                    ->rawColumns(['amount','due_amount','transaction_way','investor','action'])
                    ->make(true);
            }
    ...
    public function create()
    {
        try {
            ...
            return view('admin.account.investment.investment.create',compact('investors','bankAccounts','cash_account','bankAccounts'));
        } catch (\Exception $exception) {
    ...
    public function edit($id)
    {
        try {
            ...
            return view('admin.account.investment.investment.edit',compact('investment','availableBalance','transaction','negotiators','cash_account','investors','bankAccounts'));
        } catch (\Exception $exception) {
            return redirect()->back()->with('error', $exception->getMessage());
        }
    }
