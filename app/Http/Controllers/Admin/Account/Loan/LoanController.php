...
class LoanController extends Controller
{
    ...
    public function create()
    {
        try {
            ...
            return view('admin.account.loan.loan.create', compact('loanauthorities', 'bankAccounts','cash_account'));
        } catch (\Exception $exception) {
    ...
    public function edit($id)
    {
        try {
            ...
            return view('admin.account.loan.loan.edit', compact('loanauthorities', 'bankAccounts', 'loan','negotiators','cash_account','transaction','availableBalance'));
        } catch (\Exception $exception) {
            return redirect()->back()->with('error', $exception->getMessage());
        }
    }
