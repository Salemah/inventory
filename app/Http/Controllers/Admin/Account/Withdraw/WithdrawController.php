...
class WithdrawController extends Controller
{
    ...
    public function create()
    {
        try {
            ...
            return view('admin.account.withdraw.create',compact('bank_accounts','cash_account'));
        } catch (\Exception $exception) {
    ...
    public function edit($id)
    {
        try {
           ...
           return view('admin.account.withdraw.edit',compact('transaction','bank_accounts','accountBalance','cash_account'));
        } catch (\Exception $exception) {
