...
class ExpenseController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            if ($request->ajax()) {
                $expenses = Expense::with('expenseBy')->orderBy('expense_invoice_date','desc');
                ...
                return DataTables::of($expenses,$postBalance)
                    ...
                    ->rawColumns(['amount','expense_invoice_date','expenseBy','status', 'transaction_way','description', 'action'])
                    ->make(true);
            }
    ...
    public function create()
    {
        try {
            ...
            return view('admin.expense.expense_invoice.create', compact('expenseCategorys', 'bankAccounts', 'employees', 'serial','cash_account'));
        } catch (\Exception $exception) {
            return redirect()->back()->with('error', $exception->getMessage());
        }
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('admin.expense.expense_invoice.edit', compact('bankAccounts', 'expenseCategorys', 'expense', 'employees', 'expense_details', 'transaction', 'total', 'availableBalance', 'documents','cash_account'));
