...
class InventoryController extends Controller
{
                ...
                return DataTables::of($product)
                    ...
                    ->addColumn('action', function ($product) {
                        return '<div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                  <a href="' . route('admin.inventory.product-count.inventory.details', $product->id) . '" class="btn btn-sm btn-success text-white" style="cursor:pointer" title="Edit"><i class="bx bx-show-alt"></i></a>
                            </div>';
                    })
    ...
    public function inevntoryDetails(Request $request, $id)
    {
            try {
                ...
                $inventories = InventoryProductCount::with('products','variant')->where('product_id',$inventoryProduct->product_id)->latest()->get();
