...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item">
                 <a href="{{route('admin.account.withdraw.index')}}">Wthdraw</a>
            </li>
            <li class="breadcrumb-item">
                <a href="{{route('admin.account.withdraw.create')}}">Create</a>
            </li>
        </ol>
...
@section('content')
    ...
    <form action="{{ route('admin.account.withdraw.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
