                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="expense_invoice_no" id="expense_invoice_no" class="form-control" value="WTL-{{Carbon\Carbon::parse(date('m/d'))->format('M-d').'-EX-00'.$serial}}" placeholder="Invoice No" readonly >
