...
@section('content')
    ...
    <form action="{{ route('admin.inventory.purchase-return.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
...
@push('script')
    <script>
        ...
        $('#invoice_id').on("change",  function() {
                ...
                //$('#product_data').parents('tr').remove();
        });
