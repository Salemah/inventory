...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        ...
        <a class="btn btn-sm btn-success text-white" href="{{ route('admin.inventory.purchase-return.create') }}">
    ...
    <script>
        $(document).ready(function () {
            ...
            var dTable = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{route('admin.inventory.purchase-return.index')}}",
                    type: "get"
                },
                columns: [
        ...
        function deleteItem(id) {
            var url = '{{ route("admin.inventory.purchase.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
