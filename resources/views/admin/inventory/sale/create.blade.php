...
@section('content')
    ...
    <form action="{{ route('admin.inventory.sale.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
    ...
    <script>
        ...
        var removedItems = [];
         ...
         $(document).on('change', '#product', function () {
            ...
            var selectedOption = $('#product').find(":selected").val();
            var selectedOption2 = $('#product').find(":selected").text();
            console.log(selectedOption);
           // selectedOption.remove();
            $("#product option[value='"+selectedOption+"']").remove();
