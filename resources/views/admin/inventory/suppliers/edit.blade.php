...
<form action="{{ route('admin.inventory.suppliers.supplier.update', $supplier->id) }}" enctype="multipart/form-data" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 col-sm-12 col-md-4 mb-2" id="company">
                            ...
                            <input type="text" name="company_name" id="company_name"
                                class="form-control @error('company_name') is-invalid @enderror" value="{{ $supplier->company_name }}" placeholder="Enter company name">
                            @error('company_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-12 col-sm-12 col-md-4 mb-2">
                            ...
                            <select name="customer_type_priority" id="customer_type_priority"
                                ...
                                <option value="1" {{ $supplier->customer_type_priority == 1 ? 'selected' : '' }}>First</option>
                                <option value="2" {{ $supplier->customer_type_priority == 2 ? 'selected' : '' }}>Second</option>
                                <option value="3" {{ $supplier->customer_type_priority == 3 ? 'selected' : '' }}>Third</option>
                            </select>
                        ...
                        <div class="form-group col-12 col-sm-12 col-md-4 mb-2">
                            ...
                            <input type="text" name="tax_number" id="tax_number"
                                class="form-control"
                                value="{{ $supplier->tax_number }}" placeholder="Enter tax number">
                            ...
                            <div class="form-group">
                                ...
                                <select name="country_id" id="country_id" class="form-control select2 select">
                                    ...
                                    @foreach ($countries as $key => $country)
                                        <option value="{{ $country->id }}" @if ($country->id == $supplier->country_id) selected
                            ...
                            <div class="form-group">
                                ...
                                <select name="city_id" id="city_id" class="form-control select2 select">
                                    ...
                                    @foreach ($cities as $key => $city)
                                        <option value="{{ $city->id }}" @if ($city->id == $supplier->city_id) selected @endif> {{ $city->name }} </option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-12 col-sm-12 col-md-4 mb-2">
                            ...
                            <input type="number" name="postal_code" id="postal_code"
                                class="form-control" value="{{ $supplier->postal_code }}" placeholder="Enter postal code">
                        </div>
                        ...
                        <div class="form-group col-12 col-sm-12 col-md-4 mb-2">
                            ...
                            <input type="text" name="contact_person" id="contact_person"
                                class="form-control"
                                value="{{ $supplier->contact_person }}" placeholder="Enter contact person">
                        </div>
                        ...
                        <div class="form-group col-12 col-sm-12 col-md-4 mb-2">
                            ...
                            <select name="area_id" id="area_id" class="form-control select2 select">
                                ...
                                <option value="{{ $item->id }}" @if ($item->id == $supplier->area_id) selected @endif>{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group col-6 mb-2">
                            ...
                            <textarea name="description" id="description" rows="2" cols="3"
                                class="form-control" placeholder="Description...">{{ $supplier->description }}</textarea>
                        </div>
                        </div>
