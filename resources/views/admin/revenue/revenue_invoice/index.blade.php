...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        ...
        <a class="btn btn-sm btn-success text-white" href="{{ route('admin.revenue.create') }}">
                    ...
                    <div class="table-responsive">
                        <div class="table-responsive">
                            <table class="table  border mb-0 " id="table">
                                <thead class=" fw-semibold  dataTableHeader">
                                ...
                                <tr id="total_balance" class="bg-secondary" style="display: none">
                                    <td colspan="5" class="text-center">Total Balance</td>
...
@push('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            var dTable = $('#table').DataTable({
                ...
                columns: [
                    ...
                    // {data: 'revenue_invoice_no', name: 'revenue_invoice_no', orderable: true, searchable: true},
                    {data: 'revenue_date', name: 'revenue_date' ,orderable: true, searchable: true},
                    {data: 'description', name: 'description', orderable: true, searchable: true},
                    {data: 'amount', name: 'amount' ,orderable: true, searchable: true,class: "text-end"},
                    {data: 'revenueBy', name: 'revenueBy' ,orderable: true, searchable: true},
                ...
                footerCallback: function (row, data, start, end, display) {
                    ...
                    // Update footer
                    $(api.column(2).footer()).html(balance);
                },
            });
        });
        ...
        function deleteItem(id) {
            var url = '{{ route("admin.revenue.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
        ...
        function statusChange(id) {
            var url = '{{ route('admin.revenue.approve.status', ':id') }}';
            $.ajax({
                type: "GET",
                url: url.replace(':id', id),
                success: function(resp) {
                    ...
                    $('#table').DataTable().ajax.reload();
                    if (resp == "active") {
                        toastr.success('This status has been changed to Approve.');
                        return false;
                    } else {
