...
Route::group(['prefix' => 'inventory', 'as' => 'inventory.'], function () {
    ...
    Route::group(['prefix' => 'product-count', 'as' => 'product-count.'], function () {
        Route::get('details/{id}', [InventoryController::class, 'inevntoryDetails'])->name('inventory.details');
    });
    // Settings
    Route::group(['prefix' => 'settings', 'as' => 'settings.'], function () {
        //Unit
    ...
    Route::group(['prefix' => 'sale-return', 'as' => 'sale-return.'], function () {
        ...
        Route::get('invoice/search/{id}', [SaleReturnController::class,'saleProductSearch'])->name('sale.search');
    });
...
Route::post('salary/report/statusupdate/{id}', [SalaryReportController::class,'statusUpdate'])->name('salaryReport.update.status');
